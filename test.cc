...
// Here are some test cases to verify your multithreaded producer-consumer program:



// For each test case, you can check if your program is functioning correctly by verifying the following:

// - The total number of items produced and consumed matches the expected values.
// - The buffer size is never exceeded.
// - The program does not deadlock or crash due to incorrect synchronization.
